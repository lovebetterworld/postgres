[PostgreSQL 物流轨迹系统数据库需求分析与设计 - 包裹侠实时跟踪与召回](https://billtian.github.io/digoal.blog/2017/04/18/01.html)
...
[《PostgreSQL 10.0 preview 功能增强 - 内置分区表》](https://billtian.github.io/digoal.blog/2017/04/201612/20161215_01.md)

9.5以及以上版本，建议使用pg_pathman插件，一样可以达到分区表的目的。

[《PostgreSQL 9.5+ 高效分区表实现 - pg_pathman》](https://billtian.github.io/digoal.blog/2017/04/201610/20161024_01.md)
...
[《performance tuning about multi-rows query aggregated to single-row query》](https://billtian.github.io/digoal.blog/2017/04/201212/20121217_01.md)
