- [PostgreSQL + PostGIS 时态分析](https://www.pianshen.com/article/9715373530/)
...
postgres=# select st_isvalidtrajectory(gen_rand_linestring(1,2,10,120,now()::timestamp,(now()+interval '1 day')::timestamp,10));   st_isvalidtrajectory   
----------------------  
 t  
(1 row)  
postgres=# select st_isvalidtrajectory(gen_rand_linestring(1,2,10,120,now()::timestamp,(now()+interval '1 day')::timestamp,10));   st_isvalidtrajectory   
...
[《Oracle DBA 增值 PostgreSQL,Greenplum 学习计划》](https://github.com/digoal/blog/blob/master/201804/20180425_01.md)

# 参考

[《PostgreSQL PostGIS 的5种空间距离排序(knn)算法》](https://github.com/digoal/blog/blob/master/201806/20180605_02.md)
